...
// HIPAA, OWASP Top 10, OWASP LLM Top 10, OWASP Agentic, and
// FedRAMP Low/Moderate/High controls.
func complianceData() map[string][]FrameworkControl {
	return map[string][]FrameworkControl{
		...
		"SEC-001": { // AWS Access Key
			...
			{FedRAMPLow, "FedRAMP-L SC-12", "Cryptographic key establishment and management"},
			{FedRAMPModerate, "FedRAMP-M SC-12", "Cryptographic key establishment and management"},
			{FedRAMPHigh, "FedRAMP-H SC-12", "Cryptographic key establishment and management"},
		},
		...
		"SEC-005": { // Generic High-Entropy Secret
			...
			{OWASPTop, "OWASP A02:2021", "Cryptographic Failures"},
			{FedRAMPLow, "FedRAMP-L IA-5", "Authenticator management"},
			{FedRAMPModerate, "FedRAMP-M IA-5", "Authenticator management"},
			{FedRAMPHigh, "FedRAMP-H IA-5", "Authenticator management"},
		},
		"SEC-006": { // GCP API Key
			{CIS, "CIS 16.4", "Encrypt or hash all authentication credentials"},
			{PCIDSS, "PCI-DSS 6.5.3", "Insecure cryptographic storage"},
		...
		"SEC-045": { // Docker Hub Token
			...
			{PCIDSS, "PCI-DSS 6.5.3", "Insecure cryptographic storage"},
			{FedRAMPHigh, "FedRAMP-H SA-12", "Supply chain protection"},
		},
		...
		"IAC-001": { // Dockerfile root user
			...
			{FedRAMPModerate, "FedRAMP-M AC-6", "Least privilege"},
			{FedRAMPHigh, "FedRAMP-H AC-6", "Least privilege"},
		},
		...
		"IAC-004": { // Public CIDR 0.0.0.0/0
			...
			{FedRAMPModerate, "FedRAMP-M AC-4", "Information flow enforcement"},
			{FedRAMPHigh, "FedRAMP-H AC-4", "Information flow enforcement"},
		},
		"IAC-005": { // Encryption disabled
			...
			{HIPAA, "HIPAA 164.312(a)(2)(iv)", "Encryption and decryption"},
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{FedRAMPModerate, "FedRAMP-M SC-28", "Protection of information at rest"},
			{FedRAMPHigh, "FedRAMP-H SC-28", "Protection of information at rest"},
		},
		"IAC-006": { // SSH port 22
			...
			{SOC2, "SOC2 CC6.6", "Boundary protection"},
			{FedRAMPLow, "FedRAMP-L AC-17", "Remote access"},
			{FedRAMPModerate, "FedRAMP-M AC-17", "Remote access"},
			{FedRAMPHigh, "FedRAMP-H AC-17", "Remote access"},
		},
		...
		"IAC-011": { // GHA pull_request_target
			...
			{OWASPTop, "OWASP A08:2021", "Software and Data Integrity Failures"},
			{NIST80053, "NIST SA-12", "Supply chain protection"},
			{FedRAMPModerate, "FedRAMP-M SA-11", "Developer security testing"},
			{FedRAMPHigh, "FedRAMP-H SA-11", "Developer security testing"},
			{FedRAMPHigh, "FedRAMP-H SA-12", "Supply chain protection"},
		},
		...
		"IAC-030": { // K8s resource limits missing
			...
			{OWASPTop, "OWASP A04:2021", "Insecure Design"},
			{FedRAMPLow, "FedRAMP-L SC-5", "Denial of service protection"},
			{FedRAMPModerate, "FedRAMP-M SC-5", "Denial of service protection"},
			{FedRAMPHigh, "FedRAMP-H SC-5", "Denial of service protection"},
		},
		...
		"IAC-038": { // CloudTrail multi-region
			...
			{FedRAMPLow, "FedRAMP-L AU-2", "Audit events"},
			{FedRAMPModerate, "FedRAMP-M AU-2", "Audit events"},
			{FedRAMPHigh, "FedRAMP-H AU-2", "Audit events"},
		},
		...
		"IAC-040": { // S3 public ACL
			...
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{FedRAMPLow, "FedRAMP-L AC-3", "Access enforcement"},
			{FedRAMPModerate, "FedRAMP-M AC-3", "Access enforcement"},
			{FedRAMPHigh, "FedRAMP-H AC-3", "Access enforcement"},
		},
		"IAC-041": { // HTTP listener
			...
			{OWASPTop, "OWASP A02:2021", "Cryptographic Failures"},
			{FedRAMPModerate, "FedRAMP-M SC-8", "Transmission confidentiality"},
			{FedRAMPHigh, "FedRAMP-H SC-8", "Transmission confidentiality"},
		},
		...
		"IAC-085": { // GuardDuty not enabled
			...
			{SOC2, "SOC2 CC7.2", "Monitor system components"},
			{FedRAMPLow, "FedRAMP-L SI-4", "Information system monitoring"},
			{FedRAMPModerate, "FedRAMP-M SI-4", "Information system monitoring"},
			{FedRAMPHigh, "FedRAMP-H SI-4", "Information system monitoring"},
		},
		"IAC-086": { // Config service not enabled
			...
			{FedRAMPLow, "FedRAMP-L CM-8", "Information system component inventory"},
			{FedRAMPModerate, "FedRAMP-M CM-8", "Information system component inventory"},
			{FedRAMPHigh, "FedRAMP-H CM-8", "Information system component inventory"},
		},
		"IAC-087": { // S3 versioning disabled
			...
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{FedRAMPLow, "FedRAMP-L CP-9", "Information system backup"},
			{FedRAMPModerate, "FedRAMP-M CP-9", "Information system backup"},
			{FedRAMPHigh, "FedRAMP-H CP-9", "Information system backup"},
		},
		...
		"IAC-095": { // CloudFront without WAF
			...
			{SOC2, "SOC2 CC6.6", "Boundary protection"},
			{FedRAMPLow, "FedRAMP-L SC-7", "Boundary protection"},
			{FedRAMPModerate, "FedRAMP-M SC-7", "Boundary protection"},
			{FedRAMPHigh, "FedRAMP-H SC-7", "Boundary protection"},
		},
		...
		"IAC-104": { // Route53 DNSSEC disabled
			...
			{PCIDSS, "PCI-DSS 4.1", "Use strong cryptography during transmission"},
			{OWASPTop, "OWASP A08:2021", "Software and Data Integrity Failures"},
			{FedRAMPLow, "FedRAMP-L SC-20", "Secure name/address resolution service"},
			{FedRAMPModerate, "FedRAMP-M SC-20", "Secure name/address resolution service"},
			{FedRAMPHigh, "FedRAMP-H SC-20", "Secure name/address resolution service"},
		},
		...
		"IAC-126": { // Helm liveness probe missing
			...
			{OWASPTop, "OWASP A04:2021", "Insecure Design"},
			{FedRAMPHigh, "FedRAMP-H SI-6", "Security function verification"},
		},
		...
		"IAC-164": { // Dockerfile apt-get without --no-install-recommends
			...
			{FedRAMPLow, "FedRAMP-L CM-7", "Least functionality"},
			{FedRAMPModerate, "FedRAMP-M CM-7", "Least functionality"},
			{FedRAMPHigh, "FedRAMP-H CM-7", "Least functionality"},
			{FedRAMPHigh, "FedRAMP-H SA-12", "Supply chain protection"},
		},
		...
		"VULN-001": { // Known vulnerability
			...
			{OWASPTop, "OWASP A06:2021", "Vulnerable and Outdated Components"},
			{FedRAMPLow, "FedRAMP-L SI-2", "Flaw remediation"},
			{FedRAMPModerate, "FedRAMP-M SI-2", "Flaw remediation"},
			{FedRAMPHigh, "FedRAMP-H SI-2", "Flaw remediation"},
		},
		...
		"AI-001": { // System prompt injection risk
			...
			{OWASPTop, "OWASP A03:2021", "Injection"},
			{FedRAMPModerate, "FedRAMP-M SI-10", "Information input validation"},
			{FedRAMPHigh, "FedRAMP-H SI-10", "Information input validation"},
		},
		...
		"AI-006": { // Prompt/response logging without redaction
			...
			{HIPAA, "HIPAA 164.312(b)", "Audit controls"},
			{FedRAMPLow, "FedRAMP-L AU-3", "Content of audit records"},
			{FedRAMPModerate, "FedRAMP-M AU-3", "Content of audit records"},
			{FedRAMPHigh, "FedRAMP-H AU-3", "Content of audit records"},
		},
		...
		"DATA-001": { // Email address in source code
			...
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
			{FedRAMPModerate, "FedRAMP-M SI-12", "Information management and retention"},
			{FedRAMPHigh, "FedRAMP-H SI-12", "Information management and retention"},
		},
		...
		"IAC-186": { // Ansible no_log missing for sensitive tasks
			...
			{FedRAMPLow, "FedRAMP-L AU-2", "Event logging"},
			{FedRAMPModerate, "FedRAMP-M AU-2", "Event logging"},
			{FedRAMPHigh, "FedRAMP-H AU-2", "Event logging"},
		},
		...
		"IAC-190": { // Ansible shell/command module used instead of specific module
			...
			{OWASPTop, "OWASP A04:2021", "Insecure Design"},
			{FedRAMPLow, "FedRAMP-L CM-6", "Configuration settings"},
			{FedRAMPModerate, "FedRAMP-M CM-6", "Configuration settings"},
			{FedRAMPHigh, "FedRAMP-H CM-6", "Configuration settings"},
		},
		...
		"IAC-208": { // Ansible NTP not configured
			...
			{SOC2, "SOC2 CC7.2", "Monitor system components"},
			{FedRAMPLow, "FedRAMP-L AU-8", "Time stamps"},
			{FedRAMPModerate, "FedRAMP-M AU-8", "Time stamps"},
			{FedRAMPHigh, "FedRAMP-H AU-8", "Time stamps"},
		},
		...
		"IAC-227": { // Ansible AIDE/integrity monitoring not configured
			...
			{SOC2, "SOC2 CC7.1", "Detect and monitor changes"},
			{FedRAMPModerate, "FedRAMP-M SI-7", "Software, firmware, and information integrity"},
			{FedRAMPHigh, "FedRAMP-H SI-7", "Software, firmware, and information integrity"},
		},
		...
		"IAC-329": { // GHA deployment without rollback strategy
			...
			{OWASPTop, "OWASP A04:2021", "Insecure Design"},
			{FedRAMPLow, "FedRAMP-L CP-10", "Information system recovery and reconstitution"},
			{FedRAMPModerate, "FedRAMP-M CP-10", "Information system recovery and reconstitution"},
			{FedRAMPHigh, "FedRAMP-H CP-10", "Information system recovery and reconstitution"},
		},
		...
		"IAC-367": { // Internet-facing load balancer with HTTP listener
			...
			{HIPAA, "HIPAA 164.312(e)(1)", "Transmission security"},
			{OWASPTop, "OWASP A02:2021", "Cryptographic Failures"},
			{FedRAMPModerate, "FedRAMP-M SC-8", "Transmission confidentiality and integrity"},
			{FedRAMPHigh, "FedRAMP-H SC-8", "Transmission confidentiality and integrity"},
		},
		...
		"KRUNT-005": { // No resource limits
			...
			{OWASPTop, "OWASP A05:2021", "Security Misconfiguration"},
			{FedRAMPHigh, "FedRAMP-H SC-6", "Resource availability"},
		},
		"KRUNT-006": { // Unpinned container image
			...
			{OWASPTop, "OWASP A08:2021", "Software and Data Integrity Failures"},
			{FedRAMPModerate, "FedRAMP-M CM-3", "Configuration change control"},
			{FedRAMPModerate, "FedRAMP-M SI-7", "Software, firmware, and information integrity"},
			{FedRAMPHigh, "FedRAMP-H CM-3", "Configuration change control"},
			{FedRAMPHigh, "FedRAMP-H SI-7", "Software, firmware, and information integrity"},
		},
		...
		"GRC-001": { // Critical control gap — no evidence for high-priority control
			...
			{FedRAMPLow, "FedRAMP-L CA-2", "Security assessments"},
			{FedRAMPLow, "FedRAMP-L CA-7", "Continuous monitoring"},
			{FedRAMPModerate, "FedRAMP-M CA-2", "Security assessments"},
			{FedRAMPModerate, "FedRAMP-M CA-7", "Continuous monitoring"},
			{FedRAMPHigh, "FedRAMP-H CA-2", "Security assessments"},
			{FedRAMPHigh, "FedRAMP-H CA-7", "Continuous monitoring"},
		},
		"GRC-002": { // Framework coverage below threshold
			...
			{FedRAMPLow, "FedRAMP-L CA-2", "Security assessments"},
			{FedRAMPModerate, "FedRAMP-M CA-2", "Security assessments"},
			{FedRAMPModerate, "FedRAMP-M PM-6", "Information security measures of performance"},
			{FedRAMPHigh, "FedRAMP-H CA-2", "Security assessments"},
			{FedRAMPHigh, "FedRAMP-H PM-6", "Information security measures of performance"},
		},
		...
		"GRC-004": { // Conflicting control implementations across frameworks
			...
			{FedRAMPLow, "FedRAMP-L PL-2", "System security plans"},
			{FedRAMPModerate, "FedRAMP-M PL-2", "System security plans"},
			{FedRAMPModerate, "FedRAMP-M PM-3", "Information security resources"},
			{FedRAMPHigh, "FedRAMP-H PL-2", "System security plans"},
			{FedRAMPHigh, "FedRAMP-H PM-3", "Information security resources"},
		},
		...
		"GRC-006": { // Insufficient access control evidence (SOC2 CC6)
			...
			{NIST80053, "NIST AC-6", "Least privilege"},
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
			{FedRAMPModerate, "FedRAMP-M AC-2", "Account management"},
			{FedRAMPModerate, "FedRAMP-M AC-6", "Least privilege"},
			{FedRAMPHigh, "FedRAMP-H AC-2", "Account management"},
			{FedRAMPHigh, "FedRAMP-H AC-6", "Least privilege"},
		},
		...
		"GRC-008": { // Incomplete incident response documentation
			...
			{FedRAMPLow, "FedRAMP-L IR-1", "Incident response policy and procedures"},
			{FedRAMPLow, "FedRAMP-L IR-4", "Incident handling"},
			{FedRAMPModerate, "FedRAMP-M IR-1", "Incident response policy and procedures"},
			{FedRAMPModerate, "FedRAMP-M IR-4", "Incident handling"},
			{FedRAMPHigh, "FedRAMP-H IR-1", "Incident response policy and procedures"},
			{FedRAMPHigh, "FedRAMP-H IR-4", "Incident handling"},
		},
		...
		"REDTEAM-001": { // Multi-step attack chain detected
			...
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
			{FedRAMPLow, "FedRAMP-L RA-5", "Vulnerability scanning"},
			{FedRAMPModerate, "FedRAMP-M RA-5", "Vulnerability scanning"},
			{FedRAMPHigh, "FedRAMP-H CA-8", "Penetration testing"},
			{FedRAMPHigh, "FedRAMP-H RA-5", "Vulnerability scanning"},
		},
		...
		"REDTEAM-006": { // Validated: security header missing
			...
			{OWASPTop, "OWASP A05:2021", "Security Misconfiguration"},
			{FedRAMPModerate, "FedRAMP-M SC-8", "Transmission confidentiality and integrity"},
			{FedRAMPModerate, "FedRAMP-M SI-11", "Error handling"},
			{FedRAMPHigh, "FedRAMP-H SC-8", "Transmission confidentiality and integrity"},
			{FedRAMPHigh, "FedRAMP-H SI-11", "Error handling"},
		},
		"REDTEAM-007": { // Validated: authentication weakness exploitable
			...
			{OWASPTop, "OWASP A07:2021", "Identification and Authentication Failures"},
			{FedRAMPLow, "FedRAMP-L IA-2", "Identification and authentication"},
			{FedRAMPModerate, "FedRAMP-M IA-2", "Identification and authentication"},
			{FedRAMPHigh, "FedRAMP-H CA-8", "Penetration testing"},
			{FedRAMPHigh, "FedRAMP-H IA-2", "Identification and authentication"},
		},
		...
		"REDTEAM-009": { // Validated: TLS misconfiguration confirmed
			...
			{HIPAA, "HIPAA 164.312(e)(1)", "Transmission security"},
			{OWASPTop, "OWASP A02:2021", "Cryptographic Failures"},
			{FedRAMPLow, "FedRAMP-L SC-13", "Cryptographic protection"},
			{FedRAMPModerate, "FedRAMP-M SC-13", "Cryptographic protection"},
			{FedRAMPModerate, "FedRAMP-M SC-8", "Transmission confidentiality and integrity"},
			{FedRAMPHigh, "FedRAMP-H SC-13", "Cryptographic protection"},
			{FedRAMPHigh, "FedRAMP-H SC-8", "Transmission confidentiality and integrity"},
		},
