...
// complianceData returns the embedded compliance mapping data for all 596 rules.
...
func complianceData() map[string][]FrameworkControl {
	return map[string][]FrameworkControl{
		...
		// =================================================================
		// GRC Compliance Rules (GRC-001 through GRC-010)
		// =================================================================

		"GRC-001": { // Critical control gap — no evidence for high-priority control
			{SOC2, "SOC2 CC4.1", "COSO principle 16 — ongoing evaluations"},
			{NIST80053, "NIST CA-2", "Security assessments"},
			{NIST80053, "NIST CA-7", "Continuous monitoring"},
			{PCIDSS, "PCI-DSS 12.11", "Perform reviews at least quarterly"},
		},
		"GRC-002": { // Framework coverage below threshold
			{SOC2, "SOC2 CC4.1", "COSO principle 16 — ongoing evaluations"},
			{NIST80053, "NIST CA-2", "Security assessments"},
			{NIST80053, "NIST PM-6", "Information security measures of performance"},
			{CIS, "CIS 1.1", "Establish and maintain detailed enterprise asset inventory"},
		},
		"GRC-003": { // Stale compliance evidence (>90 days)
			{SOC2, "SOC2 CC4.2", "COSO principle 17 — evaluates and communicates deficiencies"},
			{NIST80053, "NIST CA-7", "Continuous monitoring"},
			{PCIDSS, "PCI-DSS 12.11", "Perform reviews at least quarterly"},
			{HIPAA, "HIPAA 164.308(a)(8)", "Evaluation"},
		},
		"GRC-004": { // Conflicting control implementations across frameworks
			{SOC2, "SOC2 CC3.1", "COSO principle 6 — specifies suitable objectives"},
			{NIST80053, "NIST PL-2", "System security plans"},
			{NIST80053, "NIST PM-3", "Information security resources"},
		},
		"GRC-005": { // Missing data protection controls (GDPR Art. 32)
			{HIPAA, "HIPAA 164.312(a)(1)", "Access control"},
			{HIPAA, "HIPAA 164.312(e)(1)", "Transmission security"},
			{NIST80053, "NIST SC-28", "Protection of information at rest"},
			{PCIDSS, "PCI-DSS 3.4", "Render PAN unreadable anywhere it is stored"},
		...
		"GRC-006": { // Insufficient access control evidence (SOC2 CC6)
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{SOC2, "SOC2 CC6.2", "Prior to issuing system credentials, registered and authorized"},
			{SOC2, "SOC2 CC6.3", "Role-based access and least privilege"},
			{NIST80053, "NIST AC-2", "Account management"},
			{NIST80053, "NIST AC-6", "Least privilege"},
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
		},
		"GRC-007": { // Missing encryption at rest evidence (FedRAMP)
			{NIST80053, "NIST SC-28", "Protection of information at rest"},
			{NIST80053, "NIST SC-12", "Cryptographic key establishment and management"},
			{PCIDSS, "PCI-DSS 3.4", "Render PAN unreadable anywhere it is stored"},
			{HIPAA, "HIPAA 164.312(a)(2)(iv)", "Encryption and decryption"},
		...
		"GRC-008": { // Incomplete incident response documentation
			{SOC2, "SOC2 CC7.3", "Incident response procedures"},
			{NIST80053, "NIST IR-1", "Incident response policy and procedures"},
			{NIST80053, "NIST IR-4", "Incident handling"},
			{PCIDSS, "PCI-DSS 12.10", "Implement an incident response plan"},
			{HIPAA, "HIPAA 164.308(a)(6)", "Security incident procedures"},
		},
		"GRC-009": { // Missing continuous monitoring controls (NIST CSF)
			{NIST80053, "NIST CA-7", "Continuous monitoring"},
			{NIST80053, "NIST SI-4", "Information system monitoring"},
			{SOC2, "SOC2 CC7.1", "Detection and monitoring of anomalies and events"},
			{PCIDSS, "PCI-DSS 10.6", "Review logs and security events for all system components"},
		},
		"GRC-010": { // CMMC maturity level gap
			{NIST80053, "NIST CA-2", "Security assessments"},
			{NIST80053, "NIST PM-6", "Information security measures of performance"},
			{CIS, "CIS 18.1", "Establish and maintain a penetration testing program"},
		},

		// =================================================================
		// Red Team Rules (REDTEAM-001 through REDTEAM-010)
		// =================================================================

		"REDTEAM-001": { // Multi-step attack chain detected
			{NIST80053, "NIST RA-5", "Vulnerability scanning"},
			{NIST80053, "NIST CA-8", "Penetration testing"},
			{SOC2, "SOC2 CC7.1", "Detection and monitoring of anomalies and events"},
			{PCIDSS, "PCI-DSS 11.3", "Implement a methodology for penetration testing"},
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
		},
		"REDTEAM-002": { // Privilege escalation path identified
			{NIST80053, "NIST AC-6", "Least privilege"},
			{NIST80053, "NIST CA-8", "Penetration testing"},
			{SOC2, "SOC2 CC6.3", "Role-based access and least privilege"},
			{PCIDSS, "PCI-DSS 7.1", "Limit access to system components"},
		...
		"REDTEAM-003": { // Data exfiltration path identified
			{NIST80053, "NIST SC-7", "Boundary protection"},
			{NIST80053, "NIST AC-4", "Information flow enforcement"},
			{SOC2, "SOC2 CC6.7", "Restrict transmission of data to authorized parties"},
			{PCIDSS, "PCI-DSS 6.5.4", "Insecure direct object references"},
			{HIPAA, "HIPAA 164.312(e)(1)", "Transmission security"},
			{OWASPTop, "OWASP A01:2021", "Broken Access Control"},
		},
		"REDTEAM-004": { // Container escape chain
			{CIS, "CIS 5.2.4", "Minimize the admission of containers wishing to share the host process ID namespace"},
			{NIST80053, "NIST AC-6", "Least privilege"},
			{NIST80053, "NIST CM-7", "Least functionality"},
			{PCIDSS, "PCI-DSS 2.2.1", "Implement only one primary function per server"},
			{OWASPTop, "OWASP A05:2021", "Security Misconfiguration"},
		},
		"REDTEAM-005": { // Command injection chain
			{NIST80053, "NIST SI-10", "Information input validation"},
			{NIST80053, "NIST CA-8", "Penetration testing"},
			{SOC2, "SOC2 CC6.6", "Restrict access based on need"},
			{PCIDSS, "PCI-DSS 6.5.1", "Injection flaws"},
			{OWASPTop, "OWASP A03:2021", "Injection"},
		},
		"REDTEAM-006": { // Validated: security header missing
			{NIST80053, "NIST SI-11", "Error handling"},
			{NIST80053, "NIST SC-8", "Transmission confidentiality and integrity"},
			{SOC2, "SOC2 CC6.7", "Restrict transmission of data to authorized parties"},
			{PCIDSS, "PCI-DSS 6.5.9", "Cross-site request forgery"},
			{OWASPTop, "OWASP A05:2021", "Security Misconfiguration"},
		},
		"REDTEAM-007": { // Validated: authentication weakness exploitable
			{NIST80053, "NIST IA-2", "Identification and authentication"},
			{NIST80053, "NIST CA-8", "Penetration testing"},
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{PCIDSS, "PCI-DSS 8.2", "Ensure proper user-authentication management"},
			{OWASPTop, "OWASP A07:2021", "Identification and Authentication Failures"},
		},
		"REDTEAM-008": { // Validated: injection vulnerability confirmed
			{NIST80053, "NIST SI-10", "Information input validation"},
			{NIST80053, "NIST CA-8", "Penetration testing"},
		...
		"REDTEAM-009": { // Validated: TLS misconfiguration confirmed
			{NIST80053, "NIST SC-8", "Transmission confidentiality and integrity"},
			{NIST80053, "NIST SC-13", "Cryptographic protection"},
			{SOC2, "SOC2 CC6.7", "Restrict transmission of data to authorized parties"},
			{PCIDSS, "PCI-DSS 4.1", "Use strong cryptography to safeguard cardholder data during transmission"},
			{HIPAA, "HIPAA 164.312(e)(1)", "Transmission security"},
			{OWASPTop, "OWASP A02:2021", "Cryptographic Failures"},
		},
		"REDTEAM-010": { // Validated: rate limiting absent
			{NIST80053, "NIST SC-5", "Denial of service protection"},
			{NIST80053, "NIST SI-10", "Information input validation"},
			{SOC2, "SOC2 CC6.1", "Logical and physical access controls"},
			{PCIDSS, "PCI-DSS 6.5.10", "Broken authentication and session management"},
