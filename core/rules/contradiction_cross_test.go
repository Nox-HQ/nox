...
//
// AI-023 is still in the catalogue; AI-041 was withdrawn in v1.36.0 for an
// unrelated reason, which is what resolved this pair. Both definitions are
// kept here because the pair is the only worked example this check has, and a
// check whose one example is not asserted is a check nobody can trust.
