...
func TestIsGeneratedContent(t *testing.T) {
	cases := []struct {
		...
		{"banner auto-generated", "// AUTO-GENERATED FILE - DO NOT EDIT\nexport const x = 1", true},
		{"banner go-generated", "// Code generated by protoc. DO NOT EDIT.\npackage x", true},
		{"banner @generated", "/* @generated */\nconst y = 2", true},
		{"minified long line", "const data=\"" + strings.Repeat("a", 6000) + "\"", true},
		{"normal source", "package main\n\nfunc main() {\n\tprintln(\"hi\")\n}\n", false},
		{"normal with short lines", strings.Repeat("line of code\n", 500), false},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			if got := isGeneratedContent([]byte(tc.in)); got != tc.want {
				t.Errorf("isGeneratedContent = %v, want %v", got, tc.want)
			}
		})
	}
}
